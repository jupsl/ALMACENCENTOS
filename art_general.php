    ...
    <div id="site_content">
      ...
      ?>
        ...
        <table class="tab" align="center" border="1" style="background:#BDBDBD;" width="100%">
			<tr >
				<th style="color:black;" colspan="10" align="center"  ><center>Generar Reporte de Articulos</center></th>
			...
			<tr>
				...
				<td colspan="2"><center><a href="reportes/art_general.php" target="_blank"><input class="button" type="submit" value="Generar" /></a></center></td>				
			</tr>
