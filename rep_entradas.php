...
<div id="main">
    ...
    <div id="site_content">
        ...
        <h1>Reporte de Entradas de Productos al Almacen</h1>
        <?php
       require_once('BIN/controler.php');
       
					$db= new dbManager();
					$db->configuracion("rep_entradas.php");
      ...
      ?>
        ...
        <table class="tab" align="center" border="1" style="background:#BDBDBD;" width="100%">
			<tr >
				<th style="color:black;" colspan="10" align="center"  ><center>Generar Reporte General de Entradas</center></th>
			...
			<tr>
				...
				<td colspan="2"><center><a href="reportes/rep_entradas.php" target="_blank"><input class="button" type="submit" value="Generar" /></a></center></td>				
			</tr>
