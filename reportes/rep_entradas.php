...
<div id="main">
    ...
    <div id="site_content">
        ...
        <h1>Reporte General de Entradas</h1>
        <?php
       require_once('../BIN/controler.php');
       
					$db= new dbManager();
					$db->configuracion("general.php");
                                        $entradas=$db->getEntradas();
                                        $fecha=explode(",",$entradas[0]);
                                        $nombre=explode(",",$entradas[1]);
                                        $cantidad=explode(",",$entradas[2]);
                                        $usuario=explode(",",$entradas[3]);
                                        ?>
                                        <table class="tab" align="center" border="1" width="100%" style="background:#BDBDBD;">
                                            <tr>
                                                <th colspan="5">Reporte General De Entradas en el Almacen</th>
                                            </tr>
                                            <tr>
                                                <th>Fecha</th>
                                                <th>Articulo</th>
