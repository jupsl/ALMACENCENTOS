...
<div id="main">
    ...
    <div id="site_content">
       ...
       require_once('BIN/controler.php');
		...
		if(ISSET($_POST["nkey"])){
					    ...
					    if($valida==true){
						//echo($_POST["nkey"]);
						setcookie("nproveedor",strtoupper($_POST["nkey"]));
						header("Location:proveedores.php");
					    }else{
	...
	<table class="tab" align="center" border="1" width="100%" >
		<tr>
		    <th colspan="2">Busqueda de Proveedores</th>
		</tr>
		<tr>
		    <form action="proveedores.php" method="post">
...
<tr >
			...
			<tr>
			<?php
			$prov= $db->getProovedoresBusq($_COOKIE["nproveedor"]);
	...
	<tr>
	    <td><center><form action="proveedores.php" method="post"><input type="submit" name="cb" value="cerrar" class="button"/></form></center></td>
	</tr>
     </table>
	    <?php
	     }
